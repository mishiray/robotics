                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled activity-list">
                            <li class="activity-item">
                                ...
                                <span class="activity-text">Responded to need â€œVolunteer Activitiesâ€�</span>
                            ...
                            <li class="activity-item">
                                ...
                                <div>
                                    <a href="#" class="activity-item-img"><img src="{{ $admin_source }}/assets/images/small/img-1.jpg" alt="" class="rounded mb-2"></a>
                                    <a href="#" class="activity-item-img"><img src="{{ $admin_source }}/assets/images/small/img-2.jpg" alt="" class="rounded mb-2"></a>
                                </div>
                            </li>
                            <li class="activity-item">
