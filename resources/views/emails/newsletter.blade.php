                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              ...
                              <tr>
                                <td align="center" class="hund ripplelink" width="600">
                                  <img align="center" width="70px" style="border-radius: 3px 3px 0px 0px; width: 70px; max-width: 600px!important" class="hund" src="https://airol.unilag.edu.ng/web/images/airol_2.png">
                                </td>
                              </tr>
                              <!-- END HEADER IMAGE -->
                              <!-- START BODY COPY -->
